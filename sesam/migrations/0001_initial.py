# Generated by Django 2.1.5 on 2019-04-01 08:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(null=True, verbose_name='assignment date')),
            ],
        ),
        migrations.CreateModel(
            name='Game',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(0, 'draft'), (1, 'accepted'), (2, 'rejected'), (3, 'stopped')], default=0, verbose_name='status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_users', models.ManyToManyField(related_name='assigned_categories', through='sesam.AssignedQuestionCategory', to=settings.AUTH_USER_MODEL)),
            ],
            options={
